...
var KTDatatablesBasicBasic = function() {
	...
	var initTable1 = function() {
		...
		table.DataTable({
            ...
            columns: [
                { 'data': 'fpid' },
                { 'data': 'teamPlayerDTO.upid' },
                { 'data': 'teamPlayerDTO.basicPlayerDTO.chname' },
                { 'data': 'teamPlayerDTO.basicPlayerDTO.bpid' },
                { 'data': 'teamPlayerDTO.basicPlayerDTO.offensive' },
                { 'data': 'teamPlayerDTO.basicPlayerDTO.defensive' },
                { 'data': 'teamPlayerDTO.basicPlayerDTO.position' },
                { 'data': 'timeleft' },
                { 'data': 'source' },
                { 'data': 'source' }
            ],
